...
def calculate_demographic_data(print_data=True):
    ...
    higher_education = df[df.education.isin(['Bachelors', 'Masters', 'Doctorate'])==True]
    lower_education = df[df.education.isin(['Bachelors', 'Masters', 'Doctorate'])==False]

    # percentage with salary >50K
    higher_education_rich = round(100*higher_education.salary.value_counts(normalize=True)['>50K'],1)
    lower_education_rich = round(100*lower_education.salary.value_counts(normalize=True)['>50K'],1)
    ...
    rich_percentage = round(100*df[df['hours-per-week']==min_work_hours].salary.value_counts(normalize=True)['>50K'],1)
